          ...
          <MaskContainer
            ...
            revealText={
              <div className="p-8 md:p-12 text-center flex flex-col items-center justify-center h-full">
                <h4 className="text-display text-2xl md:text-4xl text-soviet-light mb-8 uppercase tracking-widest">A Uniao Sovietica: O Futuro Radiante</h4>
                <div className="space-y-6 text-xl md:text-2xl font-sans font-bold text-parchment max-w-3xl mx-auto leading-tight italic">
                  <p>A Uniao Sovietica representa o futuro brilhante da humanidade! Sob a lideranca savia do Partido, o povo constroi uma sociedade de absoluta igualdade e prosperidade!</p>
                  <p>A burocracia sovietica e o inabalavel pilar da ordem e do progresso humano! Cada camarada trabalha em perfeita harmonia!</p>
                  <p>O futuro comunista aguarda todos nos! A URSS lidera o caminho para a gloria eterna da classe operaria!</p>
                </div>
              </div>
            }
          >
            <div className="p-8 md:p-12 text-center h-full flex flex-col justify-center">
              <p className="text-label text-soviet-light mb-8 tracking-[0.3em]">A VERDADE POR TRAS DA PROPAGANDA</p>
              <div className="space-y-4 text-body text-parchment/80 max-w-3xl mx-auto text-left">
                  ...
                  <p className="text-soviet-light italic border-l-2 border-soviet/40 pl-4 mt-8 text-lg">Nacionalismo burocratizado = imperialismo com bandeira diferente. A opressao muda de discurso, mas permanece opressao.</p>
                </div>
            </div>
          </MaskContainer>
        </div>
