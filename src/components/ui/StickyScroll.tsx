...
const posters: PosterItem[] = [
  { id: 'atraves', image: '/URSS/Atrav%C3%A9s%20dos%20Mundos%20e%20Eras.webp', title: 'Atraves dos Mundos e Eras', officialName: 'Через миры и века', meaning: 'Celebra o triunfo tecnologico sovietico. O rastro branco para as estrelas sugere que o comunismo e o destino da humanidade.', purpose: 'Mostrar a URSS como vanguarda do progresso cientifico e exploracao espacial.', flag: 'ussr' },
  { id: 'kolkhoz', image: '/URSS/Venha%20se%20juntar%20a%20n%C3%B3s%20no%20Kolkhoz!.webp', title: 'Venha se juntar no Kolkhoz!', officialName: 'Иди, товарищ, к нам в колхоз!', meaning: 'Coletivizacao Agricola. Camponeses sorridentes operando maquinario moderno.', purpose: 'Convencer que o trabalho coletivo era o caminho para abundancia.', flag: 'ussr' },
  { id: 'reptil', image: '/URSS/Esmague%20o%20R%C3%A9ptil%20Fascista!.webp', title: 'Esmague o Reptil Fascista!', officialName: 'Бей фашистского гада!', meaning: 'Cartaz da Grande Guerra Patriotica. O reptil preto e a Alemanha Nazista esmagada pelo Exercito Sovietico.', purpose: 'Desumanizar o inimigo e mobilizar a defesa da patria.', flag: 'ussr' },
  { id: 'escravidoa', image: '/URSS/Abaixo%20a%20Escravid%C3%A3o%20Dom%C3%A9stica!.webp', title: 'Abaixo a Escravidao Domestica!', officialName: 'Долой кухонное рабство!', meaning: 'Emancipacao feminina. Mulher sai da cozinha para um mundo moderno.', purpose: 'Libertar a mulher do trabalho domestico opressor.', flag: 'ussr' },
  { id: 'eletrificacao', image: '/URSS/Sovietes%20e%20Eletrifica%C3%A7%C3%A3o%20s%C3%A3o%20a%20Base%20do%20Novo%20Mundo.webp', title: 'Sovietes e Eletrificacao', officialName: 'Советы и электрификация', meaning: 'Frase de Lenin: O Comunismo e o poder sovietico mais a eletrificacao.', purpose: 'A eletricidade como simbolo da modernidade industrial.', flag: 'ussr' },
  { id: 'vsya', image: '/URSS/Todo%20o%20Poder%20aos%20Sovietes!%20Paz%20aos%20Povos.webp', title: 'Todo o Poder aos Sovietes!', officialName: 'Вся власть Советам!', meaning: 'Teses de Abril de Lenin. Paz aos povos, Terra aos camponeses, Fabricas aos operarios.', purpose: 'Consolidar apoio popular apos a Revolucao de 1917.', flag: 'ussr' },
  { id: 'cinema', image: '/URSS/Cinema%20%C3%A9%20a%20mais%20importante%20das%20artes.webp', title: 'Cinema e a mais importante das artes', officialName: 'Кино — важнейшее из искусств', meaning: 'Cineasta, remetendo a vanguarda russa e Dziga Vertov.', purpose: 'Celebrar a educacao das massas pelo cinema.', flag: 'ussr' },
  { id: 'paz', image: '/EUA/Em%20paz,%20servimos%20para%20prevenir%20a%20guerra.webp', title: 'Em paz, servimos para prevenir a guerra', officialName: 'In Peace, We Serve to Prevent War', meaning: 'Guerra Fria. Justifica presenca militar global dos EUA contra o perigo comunista.', purpose: 'Legitimar os EUA como policia do mundo e a contencao do comunismo.', flag: 'usa' },
  { id: 'fbi', image: '/EUA/Eu%20fui%20um%20Comunista%20para%20o%20FBI.webp', title: 'Eu fui um Comunista para o FBI', officialName: 'I Was a Communist for the FBI', meaning: 'Macarthismo. Comunismo como algo infiltrado e sombrio.', purpose: 'Gerar medo e paranoia, pintando comunistas como traidores.', flag: 'usa' },
  { id: 'rosie', image: '/EUA/N%C3%B3s%20conseguimos!.webp', title: 'Nos conseguimos! (Rosie)', officialName: 'We Can Do It!', meaning: 'Icone feminista WWII. Incentivar mulheres nas fabricas de armamentos.', purpose: 'Mobilizar forca de trabalho feminina para producao de guerra.', flag: 'usa' },
  { id: 'unclesam', image: '/EUA/Eu%20quero%20voc%C3%AA%20para%20o%20Ex%C3%A9rcito%20dos%20EUA.webp', title: 'Eu quero voce para o Exercito', officialName: 'Uncle Sam: I Want You for U.S. Army', meaning: 'Cartaz mais iconico de recrutamento da historia.', purpose: 'Recrutamento direto como responsabilidade individual.', flag: 'usa' },
  { id: 'cocacola', image: '/EUA/O%20que%20eu%20quero%20%C3%A9%20uma%20Coca.webp', title: 'O que eu quero e uma Coca', officialName: 'What I want is a Coke', meaning: 'Mistura propaganda de guerra com consumismo. Soldado luta pelo direito de consumir.', purpose: 'Associar marcas ao patriotismo e capitalismo como vitoria.', flag: 'usa' },
];
const symbolData = { image: '/URSS/Simbolo%20URSS.webp',
